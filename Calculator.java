...
public final class Calculator extends javax.swing.JFrame {
    ...
    private Calculator() {
        initComponents();
        facade = new CalculatorFacade(current, previous, this);
     ...
     facade.setupButtons(numbers, allBtns,btnDiv, btnEqual, btnDel,
        btnMult, btnSub, btnPlus, btnClear, btnDot, btnPlusSub);
