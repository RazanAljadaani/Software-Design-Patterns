...
public final class Calculator extends javax.swing.JFrame {
    ...
    public Calculator() {
        initComponents();
        displayManager = new DisplayManager(current, previous);
        operationManager = new OperationManager(displayManager);

        getContentPane().setSize(400, 700);
        operationManager.clear();
        
        buttonManager = new ButtonManager(this,operationManager);
        JButton[] allBtns = {
        ...
        buttonManager.addEvents(numbers, allBtns, btnDiv, btnEqual, btnDel, btnMult, btnSub, btnPlus, btnClear);
    }
    ...
    private void btnPlusActionPerformed(java.awt.event.ActionEvent evt) {                                        
        operationManager.chooseOperation("+");
    }                                       
    ...
    private void btnPlusSubActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if (!this.currentOperand.isBlank()) {
            ...
            this.displayManager.update(currentOperand, previousOperand, operation);
        }
    }                                          
